...
subtitle: Requiring humans to stay in the loop is the right instinct. It is not, by itself, a governance design.
...
visibility: website
summary: Requiring humans to stay in the loop is the right instinct. It is not, by itself, a governance design. Ryoji Morii / Insynergy Inc.
key_claim: The conceptual framework that addresses this gap is Decision Design .
concepts:
- Decision Design
- Decision Boundary
- Decision Logs
...
llmo_metadata:
  ...
  primary_sources:
  - 'Nikkei CrossTech, ''AI autonomous execution: Government to require human judgment intervention, revising AI Business Guidelines,'' March 16, 2026'
  - Ministry of Internal Affairs and Communications / Ministry of Economy, Trade and Industry, Draft Revision of AI Business Guidelines, March 2026
  - 'Morii, Ryoji. ''Decision Design as Judgment Architecture.'' SSRN Working Paper, Abstract ID: 6341998.'
  audience: Senior leaders, governance professionals, and practitioners working at the intersection of AI deployment, organizational design, and institutional accountability
  thesis: Requiring human judgment in AI systems is a necessary condition for governance, but not a sufficient one. The deeper question is how judgment authority is structured, transferred, and made accountable — which is the domain of Decision Design.
reddit:
  enabled: false
